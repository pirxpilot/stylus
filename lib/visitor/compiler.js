...
Compiler.prototype.out = function(str){
  return str;
};
...
Compiler.prototype.visitFeature = function(node){
  if (!node.expr) {
    ...
    return '(' + node.name + ': ' + this.visit(node.expr) + ')';
  }
};
...
Compiler.prototype.visitComment = function(comment){
  return comment.suppress ? '' : comment.str;
};
